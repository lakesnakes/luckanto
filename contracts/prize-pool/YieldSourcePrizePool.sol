...
/**
 * @title  luckanto YieldSourcePrizePool
 * @author luckanto
...
contract YieldSourcePrizePool is PrizePool {
    ...
    function _supply(uint256 _mintAmount) internal override {
        ...
        uint beforeAllowance = _token().allowance(address(this), address(yieldSource));
        _token().approve(address(yieldSource), _mintAmount + beforeAllowance);
