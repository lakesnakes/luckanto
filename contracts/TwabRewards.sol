...
import "@pooltogether/v4-periphery/contracts/interfaces/ITwabRewards.sol";
import {Turnstile} from "./interfaces/ITurnstile.sol";

/**
 * @title luckanto TwabRewards
 * @author luckanto
...
contract TwabRewards is ITwabRewards {
    ...
    function endPromotion(uint256 _promotionId, address _to) external override returns (bool) {
        ...
        _promotion.token.transfer(_to, _remainingRewards);
    ...
    function destroyPromotion(uint256 _promotionId, address _to) external override returns (bool) {
        ...
        _promotion.token.transfer(_to, _rewardsUnclaimed);
        ...
        returns (bool)
    {
        ...
        _promotion.token.transferFrom(msg.sender, address(this), _amount);
    ...
    function claimRewards(
        ...
        _promotion.token.transfer(_user, _rewardsAmount);
